...
function get_and_validate_department(args) {
  ...
  let
    ...
    include_public_holidays = req.body[no_suffix ? 'include_public_holidays' : 'include_public_holidays__'+index]
      ? validator.toBoolean(req.body[no_suffix ? 'include_public_holidays' : 'include_public_holidays__'+index])
      : false,
    is_accrued_allowance = req.body[no_suffix ? 'is_accrued_allowance' : 'is_accrued_allowance__'+index]
      ? validator.toBoolean(req.body[no_suffix ? 'is_accrued_allowance' : 'is_accrued_allowance__'+index])
      : false;
